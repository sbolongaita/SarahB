...
#'
#' @param x A character vector of English country names or ISO 3-character codes
#' @param iso3 A logical indicating whether `x` is a vector of ISO 3-character codes
